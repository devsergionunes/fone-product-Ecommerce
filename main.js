...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ReqProducts)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/esm/classCallCheck.js\");\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/esm/createClass.js\");\n\n\n\nvar ReqProducts = /*#__PURE__*/function () {\n  function ReqProducts(url, domImagens, domTamb) {\n    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__.default)(this, ReqProducts);\n\n    this.url = url;\n    this.domImagens = document.querySelector(domImagens);\n    this.domTamb = document.querySelector(domTamb);\n  }\n\n  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(ReqProducts, [{\n    key: \"creatTagImg\",\n    value: function creatTagImg(src, alt) {\n      this.img = document.createElement('img');\n      this.img.setAttribute('src', src);\n      this.img.setAttribute('alt', alt);\n      return this.img;\n    }\n  }, {\n    key: \"reqAllImgs\",\n    value: function reqAllImgs() {\n      var _this = this;\n\n      var products = fetch(this.url);\n      products.then(function (json) {\n        return json.json();\n      }).then(function (product) {\n        product.forEach(function (item) {\n          item.imagens.forEach(function (imagem, index) {\n            _this.domImagens.appendChild(_this.creatTagImg(imagem.src, imagem.alt));\n\n            if (index === 0) {\n              _this.domTamb.append(_this.creatTagImg(imagem.src, imagem.alt));\n            }\n          });\n        });\n      })[\"catch\"](function (erro) {\n        console.log(Error(erro));\n      });\n    }\n  }, {\n    key: \"init\",\n    value: function init() {\n      if (this.url && this.domTamb && this.domImagens) {\n        this.reqAllImgs();\n      }\n\n      return this;\n    }\n  }]);\n\n  return ReqProducts;\n}();\n\n\n\n//# sourceURL=webpack://fone-lading-page/./js/module/req-product.js?");
